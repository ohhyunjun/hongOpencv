...
def main():
    cap = cv2.VideoCapture("/home/hyunjun/hongOpencv/data/vtest.avi")
    ...
    writer = cv2.VideoWriter("/home/hyunjun/hongOpencv/data/vtest_output.avi", fourcc, fps, size)
    ...
    while True:
        ...
        put_string(frame, "Cam_01:", (10, 90), "Hyunjun")
